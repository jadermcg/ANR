...
anr <- function(fasta, alpha, beta, cutoff, niter, w = 0.5) {
    .Call('_ANR_anr', PACKAGE = 'ANR', fasta, alpha, beta, cutoff, niter, w)
}
...
#'@param w Priori probability for motif belongs to a positive model.
#'@return Updated PWM model.
loganr <- function(fasta, alpha, beta, cutoff, niter, w = 0.5) {
    .Call('_ANR_loganr', PACKAGE = 'ANR', fasta, alpha, beta, cutoff, niter, w)
}
...
Q <- function(fasta, alpha, beta) {
    .Call('_ANR_Q', PACKAGE = 'ANR', fasta, alpha, beta)
}
...
LL <- function(fasta, alpha, beta) {
    .Call('_ANR_LL', PACKAGE = 'ANR', fasta, alpha, beta)
}
...
createMarkovChain <- function(fasta, tau = 0L) {
    .Call('_ANR_createMarkovChain', PACKAGE = 'ANR', fasta, tau)
}
...
probSeqGivenAlpha <- function(kmer, alpha) {
    .Call('_ANR_probSeqGivenAlpha', PACKAGE = 'ANR', kmer, alpha)
}
...
probSeqGivenAlphaLog <- function(kmer, alpha) {
    .Call('_ANR_probSeqGivenAlphaLog', PACKAGE = 'ANR', kmer, alpha)
}
...
probSeqGivenBeta <- function(seq, beta) {
    .Call('_ANR_probSeqGivenBeta', PACKAGE = 'ANR', seq, beta)
}
...
probSeqGivenBetaLog <- function(seq, beta) {
    .Call('_ANR_probSeqGivenBetaLog', PACKAGE = 'ANR', seq, beta)
}
...
probSeqGivenPos <- function(seq, alpha, beta, pos) {
    .Call('_ANR_probSeqGivenPos', PACKAGE = 'ANR', seq, alpha, beta, pos)
}
...
probSeqGivenPosLog <- function(seq, alpha, beta, pos) {
    .Call('_ANR_probSeqGivenPosLog', PACKAGE = 'ANR', seq, alpha, beta, pos)
}
...
computeIC <- function(alpha, beta) {
    .Call('_ANR_computeIC', PACKAGE = 'ANR', alpha, beta)
}
...
computeICU <- function(alpha) {
    .Call('_ANR_computeICU', PACKAGE = 'ANR', alpha)
}
...
soft_update <- function(alpha, seq, posteriori) {
    invisible(.Call('_ANR_soft_update', PACKAGE = 'ANR', alpha, seq, posteriori))
}
...
hard_update <- function(alpha, seq, posteriori) {
    invisible(.Call('_ANR_hard_update', PACKAGE = 'ANR', alpha, seq, posteriori))
}
...
kmers2alpha <- function(kmers) {
    .Call('_ANR_kmers2alpha', PACKAGE = 'ANR', kmers)
}
...
alpha2kmers <- function(alpha, fasta) {
    .Call('_ANR_alpha2kmers', PACKAGE = 'ANR', alpha, fasta)
}
...
fasta2alpha <- function(fasta, k) {
    .Call('_ANR_fasta2alpha', PACKAGE = 'ANR', fasta, k)
}
...
corr <- function(a, b) {
    .Call('_ANR_corr', PACKAGE = 'ANR', a, b)
}
...
corr_freq <- function(correlation_str) {
    .Call('_ANR_corr_freq', PACKAGE = 'ANR', correlation_str)
}
...
fast_corr_freq <- function(a, b) {
    .Call('_ANR_fast_corr_freq', PACKAGE = 'ANR', a, b)
}
...
computeDKL <- function(alpha, beta, kmer) {
    .Call('_ANR_computeDKL', PACKAGE = 'ANR', alpha, beta, kmer)
}
...
computeDKLU <- function(alpha, kmer) {
    .Call('_ANR_computeDKLU', PACKAGE = 'ANR', alpha, kmer)
}
...
computeSCORE <- function(alpha) {
    .Call('_ANR_computeSCORE', PACKAGE = 'ANR', alpha)
}
